...
public class InvalidEmail extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if(!driver.checkUsername()){
                    Intent invalid = new Intent(InvalidEmail.this, InvalidUsername.class);
                ...
                if(!driver.checkEmail()){
                    Intent invalid = new Intent(InvalidEmail.this, InvalidEmail.class);
                    startActivity(invalid);
                    finish();
                    return;
                }
